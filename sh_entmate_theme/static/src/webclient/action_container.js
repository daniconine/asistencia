...
patch(components.ActionContainer.prototype, 'sh_entmate_theme/static/src/js/action_container.js', {
    setup() {
        this.info = {};
...
ActionContainer.template = "sh_entmate_theme.ActionContainer";
