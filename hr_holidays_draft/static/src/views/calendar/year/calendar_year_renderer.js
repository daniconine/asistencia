...
import { DraftTimeOffCalendarYearPopover } from './calendar_year_popover';

const { useEffect } = owl;

export class DraftTimeOffCalendarYearRenderer extends CalendarYearRenderer {
    setup() {
        super.setup();
        this.orm = useService("orm");
        this.stressDays = useStressDays(this.props);
        this.stressDaysList = [];
        this.stressDayPopover = useCalendarPopover(DraftTimeOffCalendarYearPopover);
